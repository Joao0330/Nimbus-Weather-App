export const About = () => {
	return (
		<section className='min-h-screen bg-gray-900 text-white p-4 relative'>
			<div className='bg-[url(../src/assets/about_bg.jpg)] bg-cover bg-center min-h-[70%] absolute top-0 left-0 right-0 z-0 overlay shadow-2xl flex items-center justify-center'>
				<div className='container flex flex-col items-center justify-center gap-10 h-full z-10'>
					...
					<a href='https://github.com/Joao0330/React-Weather-App'>View on GitHub</a>
				</div>
			</div>
		</section>
	);
